...
export const projects = [
  ...
  },
  {
    ...
    description: `블록체인 스쿨 최종 프로젝트로 진행한 결과물이며, NFT 마켓에서 요구하는 ERC-721 등록과 거래 기능을 구현했습니다. 
      또한 특정 프로필 이미지를 선택하여 NFT를 대표하는 로고를 넣도록 cloudinary를 활용한 업로드 기능을 추가했습니다.`,
  ...
  },
  {
    ...
    description:
      "tpyescript와 NextJs의 활용하고자 간단한 로그인 시스템을 구축했습니다. DB로 연결되어 저장이 가능하며 비밀번호는 bcrypt 암호화를 통해서 해쉬로 변환된 후에 저장됩니다.",
